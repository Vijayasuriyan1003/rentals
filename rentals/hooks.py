...
app_email = "viijayasuriyan.krj@gmail.com"
app_license = "mit"
# required_apps = []
...
permission_query_conditions = {
 	"vehicle": "rentals.www.hello.get_permission_query_conditions_for_vehicle",
 }
#
# has_permission = {
...
doc_events = {
 	"ToDo": {
 		"before_insert":"rentals.hello.throw_emoji"
 	}
 }
...
scheduler_events = {
 	"Cron":{
         "30 2 * * 3": [
 		"rentals.www.hello.send_payment_remainders"
 	]
    }	
 }
